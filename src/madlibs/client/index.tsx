  ...
  if (!game) {
    return (
      <form onSubmit={handleSubjectSubmit} className="space-y-4 max-w-xl mx-auto text-center">
        ...
        <button
          type="submit"
          className="inline-flex justify-center py-2 px-4 border border-transparent text-xl font-bold font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
          disabled={loading}
        >
